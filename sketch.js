   ...
   // heading.style("font-size",width/50+'px');
     ...
     select.mousePressed(()=>{
       ...
       heading.style("font-size",width/50+'px');
        ...
        heading.show();
        heading.position(width/3+20,20);
...
console.log(touches);
  ...
  if(t1.x+d11 == t4.x && t1.y == t4.y && d11<5|| t1.x-d12 == t4.x&& t1.y == t4.y && d12<5||t1.y+d13 == t4.y&&t1.x == t4.x&& d13<5||t1.y-d14 == t4.y && t1.x == t4.x&& d14<5){
